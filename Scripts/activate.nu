...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\ADMIN\Desktop\Pithon\Vscode\Big Projects\tracker_ai\Image_Aligner_Project'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\ADMIN\Desktop\Pithon\Vscode\Big Projects\tracker_ai\Image_Aligner_Project\Scripts\deactivate.nu'
